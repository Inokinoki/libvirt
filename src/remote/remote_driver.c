 ...
 */
static virLockGuard remoteDriverLock(struct private_data *driver) {
...
static int call(virConnectPtr conn, struct private_data *priv,
                unsigned int flags, int proc_nr, xdrproc_t args_filter,
                char *args, xdrproc_t ret_filter, char *ret);
static int callFull(virConnectPtr conn, struct private_data *priv,
                    unsigned int flags, int *fdin, size_t fdinlen, int **fdout,
                    size_t *fdoutlen, int proc_nr, xdrproc_t args_filter,
                    char *args, xdrproc_t ret_filter, char *ret);
...
get_nonnull_nwfilter_binding(virConnectPtr conn,
...
get_nonnull_domain_checkpoint(virDomainPtr domain,
                              remote_nonnull_domain_checkpoint checkpoint);
static virDomainSnapshotPtr
get_nonnull_domain_snapshot(virDomainPtr domain,
                            remote_nonnull_domain_snapshot snapshot);
static void make_nonnull_domain(remote_nonnull_domain *dom_dst,
                                virDomainPtr dom_src);
...
static void
make_nonnull_nwfilter_binding(remote_nonnull_nwfilter_binding *binding_dst,
...
remoteStateInitialize(bool privileged G_GNUC_UNUSED,
                      const char *root G_GNUC_UNUSED, bool monolithic,
...
remoteDomainBuildEventReboot(virNetClientProgram *prog G_GNUC_UNUSED,
                             virNetClient *client G_GNUC_UNUSED, void *evdata,
                             void *opaque);
static void
...
static void remoteDomainBuildEventRTCChange(virNetClientProgram *prog,
                                            virNetClient *client, void *evdata,
                                            void *opaque);
static void remoteDomainBuildEventCallbackRTCChange(virNetClientProgram *prog,
                                                    virNetClient *client,
                                                    void *evdata, void *opaque);

static void remoteDomainBuildEventWatchdog(virNetClientProgram *prog,
                                           virNetClient *client, void *evdata,
                                           void *opaque);
static void remoteDomainBuildEventCallbackWatchdog(virNetClientProgram *prog,
                                                   virNetClient *client,
                                                   void *evdata, void *opaque);

static void remoteDomainBuildEventIOError(virNetClientProgram *prog,
                                          virNetClient *client, void *evdata,
                                          void *opaque);
static void remoteDomainBuildEventCallbackIOError(virNetClientProgram *prog,
                                                  virNetClient *client,
                                                  void *evdata, void *opaque);

static void remoteDomainBuildEventIOErrorReason(virNetClientProgram *prog,
                                                virNetClient *client,
                                                void *evdata, void *opaque);
static void
...
static void remoteDomainBuildEventGraphics(virNetClientProgram *prog,
                                           virNetClient *client, void *evdata,
                                           void *opaque);
static void remoteDomainBuildEventCallbackGraphics(virNetClientProgram *prog,
                                                   virNetClient *client,
                                                   void *evdata, void *opaque);

static void remoteDomainBuildEventControlError(virNetClientProgram *prog,
                                               virNetClient *client,
                                               void *evdata, void *opaque);
static void
...
static void remoteDomainBuildEventBlockJob(virNetClientProgram *prog,
                                           virNetClient *client, void *evdata,
                                           void *opaque);
static void remoteDomainBuildEventCallbackBlockJob(virNetClientProgram *prog,
                                                   virNetClient *client,
                                                   void *evdata, void *opaque);

static void remoteDomainBuildEventDiskChange(virNetClientProgram *prog,
                                             virNetClient *client, void *evdata,
                                             void *opaque);
static void remoteDomainBuildEventCallbackDiskChange(virNetClientProgram *prog,
                                                     virNetClient *client,
                                                     void *evdata,
                                                     void *opaque);

static void remoteDomainBuildEventTrayChange(virNetClientProgram *prog,
                                             virNetClient *client, void *evdata,
                                             void *opaque);
static void remoteDomainBuildEventCallbackTrayChange(virNetClientProgram *prog,
                                                     virNetClient *client,
                                                     void *evdata,
                                                     void *opaque);

static void remoteDomainBuildEventPMWakeup(virNetClientProgram *prog,
                                           virNetClient *client, void *evdata,
                                           void *opaque);
static void remoteDomainBuildEventCallbackPMWakeup(virNetClientProgram *prog,
                                                   virNetClient *client,
                                                   void *evdata, void *opaque);

static void remoteDomainBuildEventPMSuspend(virNetClientProgram *prog,
                                            virNetClient *client, void *evdata,
                                            void *opaque);
static void remoteDomainBuildEventCallbackPMSuspend(virNetClientProgram *prog,
                                                    virNetClient *client,
                                                    void *evdata, void *opaque);

static void remoteDomainBuildEventBalloonChange(virNetClientProgram *prog,
                                                virNetClient *client,
                                                void *evdata, void *opaque);
static void
...
static void remoteDomainBuildEventPMSuspendDisk(virNetClientProgram *prog,
                                                virNetClient *client,
                                                void *evdata, void *opaque);
static void
...
static void remoteDomainBuildEventDeviceRemoved(virNetClientProgram *prog,
                                                virNetClient *client,
                                                void *evdata, void *opaque);
static void
remoteDomainBuildEventCallbackDeviceRemoved(virNetClientProgram *prog,
                                            virNetClient *client, void *evdata,
                                            void *opaque);
static void remoteDomainBuildEventCallbackDeviceAdded(virNetClientProgram *prog,
                                                      virNetClient *client,
                                                      void *evdata,
                                                      void *opaque);
static void
...
static void remoteDomainBuildEventBlockJob2(virNetClientProgram *prog,
                                            virNetClient *client, void *evdata,
                                            void *opaque);

static void remoteDomainBuildEventCallbackTunable(virNetClientProgram *prog,
                                                  virNetClient *client,
                                                  void *evdata, void *opaque);
...
static void remoteDomainBuildEventBlockThreshold(virNetClientProgram *prog,
                                                 virNetClient *client,
                                                 void *evdata, void *opaque);

static void remoteDomainBuildEventMemoryFailure(virNetClientProgram *prog,
                                                virNetClient *client,
                                                void *evdata, void *opaque);
...
static void remoteConnectNotifyEventConnectionClosed(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque);

static void remoteDomainBuildEventNICMACChange(virNetClientProgram *prog,
                                               virNetClient *client,
                                               void *evdata, void *opaque);

static virNetClientProgramEvent remoteEvents[] = {
    {REMOTE_PROC_DOMAIN_EVENT_LIFECYCLE, remoteDomainBuildEventLifecycle,
     sizeof(remote_domain_event_lifecycle_msg),
     (xdrproc_t)xdr_remote_domain_event_lifecycle_msg},
    {REMOTE_PROC_DOMAIN_EVENT_REBOOT, remoteDomainBuildEventReboot,
     sizeof(remote_domain_event_reboot_msg),
     (xdrproc_t)xdr_remote_domain_event_reboot_msg},
    {REMOTE_PROC_DOMAIN_EVENT_RTC_CHANGE, remoteDomainBuildEventRTCChange,
    ...
    {REMOTE_PROC_DOMAIN_EVENT_IO_ERROR, remoteDomainBuildEventIOError,
     sizeof(remote_domain_event_io_error_msg),
     (xdrproc_t)xdr_remote_domain_event_io_error_msg},
    {REMOTE_PROC_DOMAIN_EVENT_GRAPHICS, remoteDomainBuildEventGraphics,
    ...
    {REMOTE_PROC_NETWORK_EVENT_LIFECYCLE, remoteNetworkBuildEventLifecycle,
    ...
    {REMOTE_PROC_DOMAIN_EVENT_BLOCK_JOB_2, remoteDomainBuildEventBlockJob2,
    ...
    {REMOTE_PROC_STORAGE_POOL_EVENT_REFRESH, remoteStoragePoolBuildEventRefresh,
    ...
    {REMOTE_PROC_NODE_DEVICE_EVENT_UPDATE, remoteNodeDeviceBuildEventUpdate,
     sizeof(remote_node_device_event_update_msg),
     (xdrproc_t)xdr_remote_node_device_event_update_msg},
    {REMOTE_PROC_SECRET_EVENT_LIFECYCLE, remoteSecretBuildEventLifecycle,
     sizeof(remote_secret_event_lifecycle_msg),
     (xdrproc_t)xdr_remote_secret_event_lifecycle_msg},
    {REMOTE_PROC_SECRET_EVENT_VALUE_CHANGED, remoteSecretBuildEventValueChanged,
...
static virNetClientProgramEvent qemuEvents[] = {
    {QEMU_PROC_DOMAIN_MONITOR_EVENT, remoteDomainBuildQemuMonitorEvent,
     sizeof(qemu_domain_monitor_event_msg),
     (xdrproc_t)xdr_qemu_domain_monitor_event_msg},
};

static void remoteClientCloseFunc(virNetClient *client G_GNUC_UNUSED,
                                  int reason, void *opaque) {
  virConnectCloseCallbackDataCall((virConnectCloseCallbackData *)opaque,
                                  reason);
}

static bool remoteConnectSupportsFeatureUnlocked(virConnectPtr conn,
...
static char *remoteConnectFormatURI(virURI *uri, const char *driver_str,
                                    bool unmask) {
...
static int remoteCallOpen(virConnectPtr conn, struct private_data *priv,
  ...
  if (conn->uri == NULL) {
    ...
    if (call(conn, priv, 0, REMOTE_PROC_CONNECT_GET_URI, (xdrproc_t)xdr_void,
             (char *)NULL, (xdrproc_t)xdr_remote_connect_get_uri_ret,
             (char *)&uriret) < 0)
      return -1;
...
static int doRemoteOpenExtractURIArgs(
    virConnectPtr conn, char **name, char **command, char **sockname,
    char **authtype, char **sshauth, char **netcat, char **keyfile,
    char **pkipath, char **knownHosts, char **knownHostsVerify,
    char **tls_priority, char **mode_str, char **proxy_str,
#ifndef WIN32
    bool *tty,
#endif
    bool *sanity, bool *verify) {
  size_t i;
  ...
  for (i = 0; i < conn->uri->paramsCount; i++) {
    ...
    VIR_DEBUG("passing through variable '%s' ('%s') to remote end", var->name,
              var->value);
  }
 ...
 */
static int doRemoteOpen(virConnectPtr conn, struct private_data *priv,
                        const char *driver_str, remoteDriverTransport transport,
                        virConnectAuthPtr auth G_GNUC_UNUSED, virConf *conf,
                        unsigned int flags) {
  ...
  priv->hostname = g_strdup(conn->uri && conn->uri->server ? conn->uri->server
                                                           : "localhost");
  ...
  if (conn->uri) {
    ...
    if (doRemoteOpenExtractURIArgs(conn, &name, &command, &sockname, &authtype,
                                   &sshauth, &netcat, &keyfile, &pkipath,
                                   &knownHosts, &knownHostsVerify,
                                   &tls_priority, &mode_str, &proxy_str,
#ifndef WIN32
                                   &tty,
#endif
                                   &sanity, &verify) < 0) {
    ...
    if (!name) {
      if (conn->uri->scheme && (STREQ(conn->uri->scheme, "remote") ||
  ...
  if (mode_str) {
    if ((mode = remoteDriverModeTypeFromString(mode_str)) < 0) {
      virReportError(VIR_ERR_INVALID_ARG, _("Unknown remote mode '%1$s'"),
                     mode_str);
      goto error;
    }
  } else {
  ...
  if (proxy_str) {
    if ((proxy = virNetClientProxyTypeFromString(proxy_str)) < 0) {
      virReportError(VIR_ERR_INVALID_ARG, _("Unnkown proxy type '%1$s'"),
                     proxy_str);
      goto error;
    }
  } else {
  ...
  case REMOTE_DRIVER_TRANSPORT_LIBSSH2:
    if (!sockname && !(sockname = remoteGetUNIXSocket(
                           transport, mode, driver_str, flags, &daemon_path)))
      goto error;
    break;
  ...
  case REMOTE_DRIVER_TRANSPORT_TLS:
    ...
    priv->tls = virNetTLSContextNewClientPath(pkipath, geteuid() != 0,
                                              tls_priority, sanity, verify);
    if (!priv->tls)
      goto error;
    priv->is_secure = 1;
    G_GNUC_FALLTHROUGH;
  ...
  case REMOTE_DRIVER_TRANSPORT_LIBSSH2:
    ...
    priv->client = virNetClientNewLibSSH2(
        priv->hostname, port, AF_UNSPEC, username, keyfile, knownHosts,
        knownHostsVerify, sshauth, proxy, netcat, sockname,
        virtSshURI ? virtSshURI : name, flags & REMOTE_DRIVER_OPEN_RO, auth,
        conn->uri);
    if (!priv->client)
      goto error;
  ...
  case REMOTE_DRIVER_TRANSPORT_LIBSSH:
    ...
    priv->client = virNetClientNewLibssh(
        priv->hostname, port, AF_UNSPEC, username, keyfile, knownHosts,
        knownHostsVerify, sshauth, proxy, netcat, sockname,
        virtSshURI ? virtSshURI : name, flags & REMOTE_DRIVER_OPEN_RO, auth,
        conn->uri);
...
#ifndef WIN32
  case REMOTE_DRIVER_TRANSPORT_UNIX:
    if (!(priv->client = virNetClientNewUNIX(sockname, daemon_path)))
      goto error;
  ...
  case REMOTE_DRIVER_TRANSPORT_SSH:
    ...
    if (!(priv->client = virNetClientNewSSH(
              priv->hostname, port, command, username, !tty, !verify, keyfile,
              proxy, netcat, sockname, virtSshURI ? virtSshURI : name,
  ...
  virNetClientSetCloseCallback(priv->client, remoteClientCloseFunc,
                               priv->closeCallback, virObjectUnref);

  if (!(priv->remoteProgram = virNetClientProgramNew(
            REMOTE_PROGRAM, REMOTE_PROTOCOL_VERSION, remoteEvents,
            G_N_ELEMENTS(remoteEvents), conn)))
    goto error;
  if (!(priv->lxcProgram = virNetClientProgramNew(
            LXC_PROGRAM, LXC_PROTOCOL_VERSION, NULL, 0, NULL)))
    goto error;
  if (!(priv->qemuProgram =
            virNetClientProgramNew(QEMU_PROGRAM, QEMU_PROTOCOL_VERSION,
                                   qemuEvents, G_N_ELEMENTS(qemuEvents), conn)))
    goto error;
  ...
  priv->serverCloseCallback = remoteConnectSupportsFeatureUnlocked(
      conn, priv, VIR_DRV_FEATURE_REMOTE_CLOSE_CALLBACK);
...
static struct private_data *remoteAllocPrivateData(void) {
  struct private_data *priv;
...
static virDrvOpenStatus remoteConnectOpen(virConnectPtr conn,
                                          virConnectAuthPtr auth, virConf *conf,
                                          unsigned int flags) {
  ...
  VIR_WARN("remoteConnectOpen called. inside_daemon=%d URI=%s", inside_daemon,
           conn->uri ? conn->uri->scheme : "null");

  if (conn->uri) {
    if (remoteSplitURIScheme(conn->uri, &driver, &transport) < 0) {
      VIR_WARN("remoteSplitURIScheme failed");
      return VIR_DRV_OPEN_ERROR;
    }
    VIR_WARN("remoteSplitURIScheme success. driver=%s transport=%d", driver,
             transport);
  } else {
  ...
  if (inside_daemon) {
    ...
    if (!conn->uri->server && !virURICheckUnixSocket(conn->uri)) {
      if (virHasDriverForURIScheme(driver)) {
        VIR_WARN("Declining because local driver exists for scheme %s", driver);
        return VIR_DRV_OPEN_DECLINED;
      }

      if (monolithic_daemon) {
        VIR_WARN("Declining because monolithic daemon");
        return VIR_DRV_OPEN_DECLINED;
      }
    }
  }
  ...
  VIR_WARN("doRemoteOpen returned %d", ret);
...
static int doRemoteClose(virConnectPtr conn, struct private_data *priv) {
  int ret = 0;

  if (call(conn, priv, 0, REMOTE_PROC_CONNECT_CLOSE, (xdrproc_t)xdr_void,
           (char *)NULL, (xdrproc_t)xdr_void, (char *)NULL) == -1)
    ret = -1;

  g_clear_pointer(&priv->tls, virObjectUnref);

  virNetClientSetCloseCallback(priv->client, NULL, priv->closeCallback,
                               virObjectUnref);
...
static int remoteConnectClose(virConnectPtr conn) {
  int ret = 0;
  struct private_data *priv = conn->privateData;
 ...
 */
static const char *remoteConnectGetType(virConnectPtr conn) {
  ...
  if (call(conn, priv, 0, REMOTE_PROC_CONNECT_GET_TYPE, (xdrproc_t)xdr_void,
           (char *)NULL, (xdrproc_t)xdr_remote_connect_get_type_ret,
           (char *)&ret) == -1)
    return NULL;
...
static int remoteConnectIsSecure(virConnectPtr conn) {
  ...
  if (call(conn, priv, 0, REMOTE_PROC_CONNECT_IS_SECURE, (xdrproc_t)xdr_void,
           (char *)NULL, (xdrproc_t)xdr_remote_connect_is_secure_ret,
           (char *)&ret) == -1)
    return -1;
...
static int remoteNodeGetCPUStats(virConnectPtr conn, int cpuNum,
  ...
  if (call(conn, priv, 0, REMOTE_PROC_NODE_GET_CPU_STATS,
           (xdrproc_t)xdr_remote_node_get_cpu_stats_args, (char *)&args,
           (xdrproc_t)xdr_remote_node_get_cpu_stats_ret, (char *)&ret) == -1)
    return -1;
...
static int remoteNodeGetMemoryStats(virConnectPtr conn, int cellNum,
...
static int remoteNodeGetCellsFreeMemory(virConnectPtr conn,
  ...
  if (maxCells > REMOTE_NODE_MAX_CELLS) {
    virReportError(VIR_ERR_RPC, _("too many NUMA cells: %1$d > %2$d"), maxCells,
...
static int remoteConnectListDomains(virConnectPtr conn, int *ids, int maxids) {
  size_t i;
  ...
  if (maxids > REMOTE_DOMAIN_LIST_MAX) {
    virReportError(VIR_ERR_RPC, _("Too many domains '%1$d' for limit '%2$d'"),
...
remoteDeserializeDomainDiskErrors(remote_domain_disk_error *ret_errors_val,
                                  u_int ret_errors_len, int limit,
                                  virDomainDiskErrorPtr errors, int maxerrors) {
  size_t i = 0;
...
static int remoteDomainBlockStatsFlags(virDomainPtr domain, const char *path,
  ...
  if (ret.params.params_len > REMOTE_DOMAIN_BLOCK_STATS_PARAMETERS_MAX ||
      ret.params.params_len > *nparams) {
    virReportError(VIR_ERR_RPC, "%s",
                   _("remoteDomainBlockStatsFlags: returned number of stats "
                     "exceeds limit"));
    return -1;
  }
  ...
  *nparams = ret.params.params_len;
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_BLOCK_STATS_PARAMETERS_MAX,
          &params, nparams) < 0)
    return -1;
...
static int remoteDomainGetMemoryParameters(virDomainPtr domain,
                                           virTypedParameterPtr params,
                                           int *nparams, unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_MEMORY_PARAMETERS_MAX, &params,
          nparams) < 0)
    return -1;
...
static int remoteDomainGetNumaParameters(virDomainPtr domain,
                                         virTypedParameterPtr params,
                                         int *nparams, unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_NUMA_PARAMETERS_MAX, &params,
          nparams) < 0)
    return -1;
...
static int remoteDomainGetLaunchSecurityInfo(virDomainPtr domain,
                                             virTypedParameterPtr *params,
                                             int *nparams, unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_LAUNCH_SECURITY_INFO_PARAMS_MAX,
          params, nparams) < 0)
    return -1;
...
static int remoteDomainGetPerfEvents(virDomainPtr domain,
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_PERF_EVENTS_MAX, params,
          nparams) < 0)
    return -1;
...
static int remoteDomainGetBlkioParameters(virDomainPtr domain,
                                          virTypedParameterPtr params,
                                          int *nparams, unsigned int flags) {
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_BLKIO_PARAMETERS,
           ...
           (char *)&args, (xdrproc_t)xdr_remote_domain_get_blkio_parameters_ret,
           (char *)&ret) == -1)
    return -1;
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_BLKIO_PARAMETERS_MAX, &params,
          nparams) < 0)
    return -1;
...
static int remoteDomainGetVcpuPinInfo(virDomainPtr domain, int ncpumaps,
  ...
  if (ncpumaps > REMOTE_VCPUINFO_MAX) {
    virReportError(VIR_ERR_RPC, _("vCPU count exceeds maximum: %1$d > %2$d"),
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_VCPU_PIN_INFO,
           (xdrproc_t)xdr_remote_domain_get_vcpu_pin_info_args, (char *)&args,
           (xdrproc_t)xdr_remote_domain_get_vcpu_pin_info_ret,
           (char *)&ret) == -1)
    return -1;

  if (ret.num > ncpumaps) {
    virReportError(VIR_ERR_RPC, _("host reports too many vCPUs: %1$d > %2$d"),
                   ret.num, ncpumaps);
    return -1;
  }
...
static int remoteDomainPinEmulator(virDomainPtr dom, unsigned char *cpumap,
  ...
  if (cpumaplen > REMOTE_CPUMAP_MAX) {
    virReportError(VIR_ERR_RPC,
                   _("%1$s length greater than maximum: %2$d > %3$d"), "cpumap",
                   cpumaplen, REMOTE_CPUMAP_MAX);
    return -1;
  }
  ...
  if (call(dom->conn, priv, 0, REMOTE_PROC_DOMAIN_PIN_EMULATOR,
           (xdrproc_t)xdr_remote_domain_pin_emulator_args, (char *)&args,
           (xdrproc_t)xdr_void, (char *)NULL) == -1)
    return -1;
...
static int remoteDomainGetEmulatorPinInfo(virDomainPtr domain,
                                          unsigned char *cpumaps, int maplen,
                                          unsigned int flags) {
  size_t i;
...
static int remoteDomainGetVcpus(virDomainPtr domain, virVcpuInfoPtr info,
                                int maxinfo, unsigned char *cpumaps,
                                int maplen) {
  size_t i;
...
static int remoteDomainGetIOThreadInfo(virDomainPtr dom,
  ...
  if (call(dom->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_IOTHREAD_INFO,
           (xdrproc_t)xdr_remote_domain_get_iothread_info_args, (char *)&args,
...
static int remoteDomainGetSecurityLabel(virDomainPtr domain,
...
static int remoteDomainGetSecurityLabelList(virDomainPtr domain,
...
static int remoteDomainGetState(virDomainPtr domain, int *state, int *reason,
                                unsigned int flags) {
...
static int remoteNodeGetSecurityModel(virConnectPtr conn,
...
static int remoteDomainMigratePrepare(virConnectPtr dconn, char **cookie,
                                      int *cookielen, const char *uri_in,
                                      char **uri_out, unsigned long flags,
                                      const char *dname,
...
static int remoteDomainMigratePrepare2(virConnectPtr dconn, char **cookie,
                                       int *cookielen, const char *uri_in,
                                       char **uri_out, unsigned long flags,
                                       const char *dname,
                                       unsigned long bandwidth,
  ...
  if (ret.uri_out) {
    if (!uri_out) {
      virReportError(VIR_ERR_INTERNAL_ERROR, "%s", _("caller ignores uri_out"));
      return -1;
    }
    *uri_out = g_steal_pointer(ret.uri_out); /* Caller frees. */
  }
...
static int remoteDomainCreate(virDomainPtr domain) {
...
static char *remoteDomainGetSchedulerType(virDomainPtr domain, int *nparams) {
...
static int remoteDomainMemoryStats(virDomainPtr domain,
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_MEMORY_STATS,
           (xdrproc_t)xdr_remote_domain_memory_stats_args, (char *)&args,
           (xdrproc_t)xdr_remote_domain_memory_stats_ret, (char *)&ret) == -1)
    return -1;
...
static int remoteDomainBlockPeek(virDomainPtr domain, const char *path,
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_BLOCK_PEEK,
           (xdrproc_t)xdr_remote_domain_block_peek_args, (char *)&args,
           (xdrproc_t)xdr_remote_domain_block_peek_ret, (char *)&ret) == -1)
    return -1;
...
static int remoteDomainMemoryPeek(virDomainPtr domain,
                                  unsigned long long offset, size_t size,
                                  void *buffer, unsigned int flags) {
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_MEMORY_PEEK,
           (xdrproc_t)xdr_remote_domain_memory_peek_args, (char *)&args,
           (xdrproc_t)xdr_remote_domain_memory_peek_ret, (char *)&ret) == -1)
    return -1;
...
static int remoteDomainGetBlockJobInfo(virDomainPtr domain, const char *path,
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_BLOCK_JOB_INFO,
           (xdrproc_t)xdr_remote_domain_get_block_job_info_args, (char *)&args,
...
static int remoteDomainGetBlockIoTune(virDomainPtr domain, const char *disk,
                                      virTypedParameterPtr params, int *nparams,
                                      unsigned int flags) {
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_BLOCK_IO_TUNE,
           (xdrproc_t)xdr_remote_domain_get_block_io_tune_args, (char *)&args,
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_BLOCK_IO_TUNE_PARAMETERS_MAX,
          &params, nparams) < 0)
    return -1;
...
static int remoteDomainGetCPUStats(virDomainPtr domain,
  ...
  if (nparams > REMOTE_NODE_CPU_STATS_MAX) {
    virReportError(VIR_ERR_RPC, _("nparams count exceeds maximum: %1$u > %2$u"),
                   nparams, REMOTE_NODE_CPU_STATS_MAX);
    return -1;
  }
  if (ncpus > REMOTE_DOMAIN_GET_CPU_STATS_NCPUS_MAX) {
    virReportError(VIR_ERR_RPC, _("ncpus count exceeds maximum: %1$u > %2$u"),
  ...
  if (call(domain->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_CPU_STATS,
           (xdrproc_t)xdr_remote_domain_get_cpu_stats_args, (char *)&args,
           (xdrproc_t)xdr_remote_domain_get_cpu_stats_ret, (char *)&ret) == -1)
    return -1;
  ...
  for (cpu = 0; cpu < ncpus; cpu++) {
    ...
    if (virTypedParamsDeserialize((struct _virTypedParameterRemote *)stride,
                                  ret.nparams, REMOTE_NODE_CPU_STATS_MAX,
                                  &cpu_params, &tmp) < 0) {
...
static int remoteConnectNetworkEventRegisterAny(
    virConnectPtr conn, virNetworkPtr net, int eventID,
    virConnectNetworkEventGenericCallback callback, void *opaque,
  ...
  if ((count = virNetworkEventStateRegisterClient(conn, priv->eventState, net,
                                                  eventID, callback, opaque,
                                                  freecb, &callbackID)) < 0)
    return -1;
  ...
  if (count == 1) {
    ...
    if (call(conn, priv, 0, REMOTE_PROC_CONNECT_NETWORK_EVENT_REGISTER_ANY,
             ...
             (char *)&ret) == -1) {
      virObjectEventStateDeregisterID(conn, priv->eventState, callbackID,
                                      false);
      return -1;
    }
...
static int remoteConnectNetworkEventDeregisterAny(virConnectPtr conn,
                                                  int callbackID) {
  struct private_data *priv = conn->privateData;
  ...
  if ((eventID = virObjectEventStateEventID(conn, priv->eventState, callbackID,
                                            &remoteID)) < 0)
    return -1;
...
static int remoteConnectStoragePoolEventRegisterAny(
    virConnectPtr conn, virStoragePoolPtr pool, int eventID,
    virConnectStoragePoolEventGenericCallback callback, void *opaque,
    virFreeCallback freecb) {
  struct private_data *priv = conn->privateData;
  ...
  if ((count = virStoragePoolEventStateRegisterClient(
           conn, priv->eventState, pool, eventID, callback, opaque, freecb,
           &callbackID)) < 0)
    return -1;
...
static int remoteConnectStoragePoolEventDeregisterAny(virConnectPtr conn,
                                                      int callbackID) {
  struct private_data *priv = conn->privateData;
  ...
  if (count == 0) {
    ...
    if (call(conn, priv, 0,
             ...
             (xdrproc_t)
                 xdr_remote_connect_storage_pool_event_deregister_any_args,
             (char *)&args, (xdrproc_t)xdr_void, (char *)NULL) == -1)
      return -1;
  }
...
static int remoteConnectNodeDeviceEventRegisterAny(
    virConnectPtr conn, virNodeDevicePtr dev, int eventID,
    virConnectNodeDeviceEventGenericCallback callback, void *opaque,
    virFreeCallback freecb) {
  struct private_data *priv = conn->privateData;
  ...
  if ((count = virNodeDeviceEventStateRegisterClient(
           conn, priv->eventState, dev, eventID, callback, opaque, freecb,
           &callbackID)) < 0)
    return -1;
...
static int remoteConnectNodeDeviceEventDeregisterAny(virConnectPtr conn,
                                                     int callbackID) {
  struct private_data *priv = conn->privateData;
  ...
  if (count == 0) {
    ...
    if (call(
            conn, priv, 0, REMOTE_PROC_CONNECT_NODE_DEVICE_EVENT_DEREGISTER_ANY,
...
static int remoteConnectSecretEventRegisterAny(
    virConnectPtr conn, virSecretPtr secret, int eventID,
    virConnectSecretEventGenericCallback callback, void *opaque,
    virFreeCallback freecb) {
  struct private_data *priv = conn->privateData;
  ...
  if ((count = virSecretEventStateRegisterClient(conn, priv->eventState, secret,
                                                 eventID, callback, opaque,
                                                 freecb, &callbackID)) < 0)
    return -1;
...
static int remoteConnectSecretEventDeregisterAny(virConnectPtr conn,
                                                 int callbackID) {
  struct private_data *priv = conn->privateData;
...
static int remoteConnectDomainQemuMonitorEventRegister(
    virConnectPtr conn, virDomainPtr dom, const char *event,
    virConnectDomainQemuMonitorEventCallback callback, void *opaque,
    virFreeCallback freecb, unsigned int flags) {
  struct private_data *priv = conn->privateData;
  ...
  if ((count = virDomainQemuMonitorEventStateRegisterID(
           conn, priv->eventState, dom, event, callback, opaque, freecb, -1,
           &callbackID)) < 0)
    return -1;
...
static int remoteConnectDomainQemuMonitorEventDeregister(virConnectPtr conn,
                                                         int callbackID) {
  struct private_data *priv = conn->privateData;
  ...
  if (virObjectEventStateEventID(conn, priv->eventState, callbackID,
                                 &remoteID) < 0)
    return -1;
...
static char *remoteConnectFindStoragePoolSources(virConnectPtr conn,
                                                 const char *type,
                                                 const char *srcSpec,
                                                 unsigned int flags) {
...
static int remoteNodeDeviceDettach(virNodeDevicePtr dev) {
...
static int remoteNodeDeviceDetachFlags(virNodeDevicePtr dev,
  ...
  if (call(dev->conn, priv, 0, REMOTE_PROC_NODE_DEVICE_DETACH_FLAGS,
           (xdrproc_t)xdr_remote_node_device_detach_flags_args, (char *)&args,
           (xdrproc_t)xdr_void, (char *)NULL) == -1)
    return -1;
...
static int remoteNodeDeviceReAttach(virNodeDevicePtr dev) {
...
static int remoteNodeDeviceReset(virNodeDevicePtr dev) {
...
static int remoteAuthenticate(virConnectPtr conn, struct private_data *priv,
  ...
  err = call(conn, priv, 0, REMOTE_PROC_AUTH_LIST, (xdrproc_t)xdr_void,
             (char *)NULL, (xdrproc_t)xdr_remote_auth_list_ret, (char *)&ret);
  if (err < 0) {
  ...
  if (authtype) {
    int want;
    size_t i;
    if (STRCASEEQ(authtype, "sasl") || STRCASEEQLEN(authtype, "sasl.", 5)) {
      want = REMOTE_AUTH_SASL;
    } else if (STRCASEEQ(authtype, "polkit")) {
      want = REMOTE_AUTH_POLKIT;
    } else {
      virReportError(VIR_ERR_AUTH_FAILED, _("unknown authentication type %1$s"),
                     authtype);
      return -1;
    }
  ...
  case REMOTE_AUTH_SASL: {
    ...
    if (authtype && STRCASEEQLEN(authtype, "sasl.", 5))
      mech = authtype + 5;
...
static int remoteAuthFillFromConfig(virConnectPtr conn,
  ...
  for (ninteract = 0; state->interact[ninteract].id != 0; ninteract++) {
    ...
    if (credname &&
        virAuthConfigLookup(state->config, "libvirt", VIR_URI_SERVER(conn->uri),
                            credname, &value) < 0)
      return -1;
...
static int remoteAuthInteract(virConnectPtr conn,
  ...
  if (remoteAuthMakeCredentials(state->interact, &state->cred, &state->ncred) <
      0) {
...
static int remoteAuthSASL(virConnectPtr conn, struct private_data *priv,
  ...
  if (!(sasl = virNetSASLSessionNewClient(
            saslCtxt, "libvirt", priv->hostname,
            virNetClientLocalAddrStringSASL(priv->client),
            virNetClientRemoteAddrStringSASL(priv->client), saslcb)))
    goto cleanup;
  ...
  if (call(conn, priv, 0, REMOTE_PROC_AUTH_SASL_INIT, (xdrproc_t)xdr_void,
           (char *)NULL, (xdrproc_t)xdr_remote_auth_sasl_init_ret,
           (char *)&iret) != 0)
    goto cleanup;
...
restart:
  ...
  if ((err = virNetSASLSessionClientStart(sasl, mechlist, &state.interact,
  ...
  VIR_DEBUG("Server start negotiation with mech %s. Data %zu bytes %p", mech,
  ...
  VIR_DEBUG("Client step result complete: %d. Data %zu bytes %p", complete,
            serverinlen, serverin);
  ...
  /* Loop-the-loop...
   * Even if the server has completed, the client must *always* do at least one
   * step in this loop to verify the server isn't lying about something. Mutual
   * auth */
  for (;;) {
    remote_auth_sasl_step_args pargs = {0};
    remote_auth_sasl_step_ret pret = {0};

    if ((err = virNetSASLSessionClientStep(sasl, serverin, serverinlen,
                                           &state.interact, &clientout,
                                           &clientoutlen)) < 0)
      goto cleanup;
    ...
    VIR_FREE(serverin);
    VIR_DEBUG("Client step result %d. Data %zu bytes %p", err, clientoutlen,
              clientout);
    ...
    VIR_DEBUG("Server step with %zu bytes %p", clientoutlen, clientout);
...
static int remoteAuthPolkit(virConnectPtr conn, struct private_data *priv,
  ...
  if (call(conn, priv, 0, REMOTE_PROC_AUTH_POLKIT, (xdrproc_t)xdr_void,
           (char *)NULL, (xdrproc_t)xdr_remote_auth_polkit_ret,
           (char *)&ret) != 0) {
...
remoteConnectDomainEventRegister(virConnectPtr conn,
  ...
  if ((count = virDomainEventStateRegisterClient(
           conn, priv->eventState, NULL, VIR_DOMAIN_EVENT_ID_LIFECYCLE,
           VIR_DOMAIN_EVENT_CALLBACK(callback), opaque, freecb, true,
           &callbackID, priv->serverEventFilter)) < 0)
    return -1;
  ...
  if (count == 1) {
    ...
    if (priv->serverEventFilter) {
      ...
      if (call(conn, priv, 0,
               ...
               (xdrproc_t)
                   xdr_remote_connect_domain_event_callback_register_any_args,
               (char *)&args,
               (xdrproc_t)
                   xdr_remote_connect_domain_event_callback_register_any_ret,
               (char *)&ret) == -1) {
        virObjectEventStateDeregisterID(conn, priv->eventState, callbackID,
                                        false);
        return -1;
  ...
  if (count == 0) {
    ...
    if (priv->serverEventFilter) {
      ...
      if (call(conn, priv, 0,
               ...
               (xdrproc_t)
                   xdr_remote_connect_domain_event_callback_deregister_any_args,
               (char *)&args, (xdrproc_t)xdr_void, (char *)NULL) == -1)
        return -1;
    } else {
...
static void remoteDomainBuildEventRebootHelper(
    virConnectPtr conn, remote_domain_event_reboot_msg *msg, int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
...
static void remoteDomainBuildEventWatchdogHelper(
    virConnectPtr conn, remote_domain_event_watchdog_msg *msg, int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
...
static void remoteDomainBuildEventIOErrorHelper(
    virConnectPtr conn, remote_domain_event_io_error_msg *msg, int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
  ...
  event = virDomainEventIOErrorNewFromDom(dom, msg->srcPath, msg->devAlias,
                                          msg->action);
  virObjectUnref(dom);
...
static void remoteDomainBuildEventIOErrorReasonHelper(
    virConnectPtr conn, remote_domain_event_io_error_reason_msg *msg,
    int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
  ...
  event = virDomainEventIOErrorReasonNewFromDom(
      dom, msg->srcPath, msg->devAlias, msg->action, msg->reason);
...
static void remoteDomainBuildEventCallbackIOErrorReason(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
remoteDomainBuildEventBlockJobHelper(virConnectPtr conn,
  ...
  event =
      virDomainEventBlockJobNewFromDom(dom, msg->path, msg->type, msg->status);
...
remoteDomainBuildEventBlockJob2(virNetClientProgram *prog G_GNUC_UNUSED,
  ...
  event =
      virDomainEventBlockJob2NewFromDom(dom, msg->dst, msg->type, msg->status);
...
static void remoteDomainBuildEventGraphicsHelper(
    virConnectPtr conn, remote_domain_event_graphics_msg *msg, int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
  ...
  subject->identities =
      g_new0(virDomainEventGraphicsSubjectIdentity, msg->subject.subject_len);
  ...
  event = virDomainEventGraphicsNewFromDom(
      dom, msg->phase, localAddr, remoteAddr, msg->authScheme, subject);
...
static void remoteDomainBuildEventControlErrorHelper(
    virConnectPtr conn, remote_domain_event_control_error_msg *msg,
    int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
...
static void remoteDomainBuildEventCallbackControlError(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
remoteDomainBuildEventDiskChangeHelper(virConnectPtr conn,
  ...
  event = virDomainEventDiskChangeNewFromDom(
      dom, msg->oldSrcPath ? *msg->oldSrcPath : NULL,
      msg->newSrcPath ? *msg->newSrcPath : NULL, msg->devAlias, msg->reason);
...
static void remoteDomainBuildEventCallbackDiskChange(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
remoteDomainBuildEventTrayChangeHelper(virConnectPtr conn,
  ...
  event = virDomainEventTrayChangeNewFromDom(dom, msg->devAlias, msg->reason);
...
static void remoteDomainBuildEventCallbackTrayChange(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
static void remoteDomainBuildEventBalloonChangeHelper(
    virConnectPtr conn, remote_domain_event_balloon_change_msg *msg,
    int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
...
static void remoteDomainBuildEventCallbackBalloonChange(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
static void remoteDomainBuildEventPMSuspendDiskHelper(
    virConnectPtr conn, remote_domain_event_pmsuspend_disk_msg *msg,
    int callbackID, int reason) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
...
static void remoteDomainBuildEventCallbackPMSuspendDisk(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
static void remoteDomainBuildEventDeviceRemovedHelper(
    virConnectPtr conn, remote_domain_event_device_removed_msg *msg,
    int callbackID) {
  struct private_data *priv = conn->privateData;
  virDomainPtr dom;
  virObjectEvent *event = NULL;
...
static void remoteDomainBuildEventCallbackDeviceRemoved(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
static void remoteDomainBuildEventCallbackDeviceAdded(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
static void remoteDomainBuildEventCallbackDeviceRemovalFailed(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
remoteDomainBuildEventCallbackTunable(virNetClientProgram *prog G_GNUC_UNUSED,
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)msg->params.params_val,
          msg->params.params_len, REMOTE_DOMAIN_EVENT_TUNABLE_MAX, &params,
          &nparams) < 0)
    return;
...
static void remoteDomainBuildEventCallbackAgentLifecycle(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
  ...
  event = virDomainEventAgentLifecycleNewFromDom(dom, msg->state, msg->reason);
...
static void remoteDomainBuildEventCallbackMigrationIteration(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
...
static void remoteDomainBuildEventCallbackJobCompleted(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)msg->params.params_val,
          msg->params.params_len, REMOTE_DOMAIN_JOB_STATS_MAX, &params,
          &nparams) < 0)
    return;
...
static void remoteDomainBuildEventCallbackMetadataChange(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
  ...
  event = virDomainEventMetadataChangeNewFromDom(
      dom, msg->type, msg->nsuri ? *msg->nsuri : NULL);
...
static void remoteNetworkBuildEventCallbackMetadataChange(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
  ...
  event = virNetworkEventMetadataChangeNewFromNet(
      net, msg->type, msg->nsuri ? *msg->nsuri : NULL);
...
remoteNodeDeviceBuildEventLifecycle(virNetClientProgram *prog G_GNUC_UNUSED,
  ...
  event = virNodeDeviceEventLifecycleNew(dev->name, msg->event, msg->detail);
  virObjectUnref(dev);
...
remoteSecretBuildEventLifecycle(virNetClientProgram *prog G_GNUC_UNUSED,
  ...
  event = virSecretEventLifecycleNew(secret->uuid, secret->usageType,
                                     secret->usageID, msg->event, msg->detail);
...
remoteDomainBuildQemuMonitorEvent(virNetClientProgram *prog G_GNUC_UNUSED,
  ...
  event = virDomainQemuMonitorEventNew(dom->id, dom->name, dom->uuid,
                                       msg->event, msg->seconds, msg->micros,
...
static unsigned char *remoteSecretGetValue(virSecretPtr secret,
                                           size_t *value_size,
                                           unsigned int flags) {
  ...
  *value_size = ret.value.value_len;
  return (unsigned char *)g_steal_pointer(
      &ret.value.value_val); /* Caller frees. */
}
...
static void remoteDomainBuildEventMemoryDeviceSizeChange(
    virNetClientProgram *prog G_GNUC_UNUSED, virNetClient *client G_GNUC_UNUSED,
    void *evdata, void *opaque) {
  virConnectPtr conn = opaque;
  ...
  event = virDomainEventMemoryDeviceSizeChangeNewFromDom(dom, msg->alias,
                                                         msg->size);
...
remoteDomainBuildEventNICMACChange(virNetClientProgram *prog G_GNUC_UNUSED,
  ...
  event = virDomainEventNICMACChangeNewFromDom(dom, msg->alias, msg->oldMAC,
                                               msg->newMAC);
...
static int remoteStreamSend(virStreamPtr st, const char *data, size_t nbytes) {
  ...
  rv = virNetClientStreamSendPacket(privst, priv->client, VIR_NET_CONTINUE,
                                    data, nbytes);
...
static int remoteStreamRecvFlags(virStreamPtr st, char *data, size_t nbytes,
                                 unsigned int flags) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  int rv;

  VIR_DEBUG("st=%p data=%p nbytes=%zu flags=0x%x", st, data, nbytes, flags);
  ...
  rv = virNetClientStreamRecvPacket(privst, priv->client, data, nbytes,
                                    (st->flags & VIR_STREAM_NONBLOCK), flags);
...
static int remoteStreamRecv(virStreamPtr st, char *data, size_t nbytes) {
  return remoteStreamRecvFlags(st, data, nbytes, 0);
}

static int remoteStreamSendHole(virStreamPtr st, long long length,
                                unsigned int flags) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  int rv;

  VIR_DEBUG("st=%p length=%lld flags=0x%x", st, length, flags);

  remoteDriverLock(priv);
  priv->localUses++;
  remoteDriverUnlock(priv);

  rv = virNetClientStreamSendHole(privst, priv->client, length, flags);
...
static int remoteStreamRecvHole(virStreamPtr st, long long *length,
                                unsigned int flags) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  int rv;

  VIR_DEBUG("st=%p length=%p flags=0x%x", st, length, flags);
...
static int remoteStreamInData(virStreamPtr st, int *data, long long *length) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  int rv;

  VIR_DEBUG("st=%p data=%p length=%p", st, data, length);
...
static int remoteStreamEventAddCallback(virStreamPtr st, int events,
                                        virStreamEventCallback cb, void *opaque,
                                        virFreeCallback ff) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  int ret = -1;
  ...
  if ((ret = virNetClientStreamEventAddCallback(
           privst, events, remoteStreamEventCallback, cbdata,
...
static int remoteStreamEventUpdateCallback(virStreamPtr st, int events) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  VIR_LOCK_GUARD lock = remoteDriverLock(priv);
...
static int remoteStreamEventRemoveCallback(virStreamPtr st) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  VIR_LOCK_GUARD lock = remoteDriverLock(priv);
...
static int remoteStreamCloseInt(virStreamPtr st, bool streamAbort) {
  struct private_data *priv = st->conn->privateData;
  virNetClientStream *privst = st->privateData;
  int ret = -1;
  ...
  ret = virNetClientStreamSendPacket(
      privst, priv->client, streamAbort ? VIR_NET_ERROR : VIR_NET_OK, NULL, 0);
...
static int remoteStreamFinish(virStreamPtr st) {
  return remoteStreamCloseInt(st, false);
}

static int remoteStreamAbort(virStreamPtr st) {
...
static int remoteConnectDomainEventRegisterAny(
    virConnectPtr conn, virDomainPtr dom, int eventID,
    virConnectDomainEventGenericCallback callback, void *opaque,
    virFreeCallback freecb) {
  struct private_data *priv = conn->privateData;
  int callbackID;
  int count;
  ...
  if ((count = virDomainEventStateRegisterClient(
           conn, priv->eventState, dom, eventID, callback, opaque, freecb,
           false, &callbackID, priv->serverEventFilter)) < 0)
    return -1;
...
static int remoteDomainQemuMonitorCommand(virDomainPtr domain, const char *cmd,
  ...
  if (call(domain->conn, priv, REMOTE_CALL_QEMU,
           QEMU_PROC_DOMAIN_MONITOR_COMMAND,
...
static int
remoteDomainQemuMonitorCommandWithFiles(virDomainPtr domain, const char *cmd,
                                        unsigned int ninfiles, int *infiles,
                                        unsigned int *noutfiles, int **outfiles,
                                        char **result, unsigned int flags) {
  ...
  if (callFull(domain->conn, priv, REMOTE_CALL_QEMU, infiles, ninfiles,
               &rpc_outfiles, &rpc_noutfiles,
               QEMU_PROC_DOMAIN_MONITOR_COMMAND_WITH_FILES,
               (xdrproc_t)xdr_qemu_domain_monitor_command_with_files_args,
               (char *)&args,
               (xdrproc_t)xdr_qemu_domain_monitor_command_with_files_ret,
               (char *)&ret) == -1)
    return -1;
...
static char *remoteDomainMigrateBegin3(virDomainPtr domain, const char *xmlin,
  ...
  if (ret.cookie_out.cookie_out_len > 0) {
    ...
    *cookieout =
        g_steal_pointer(&ret.cookie_out.cookie_out_val); /* Caller frees. */
...
static int remoteDomainMigratePrepare3(virConnectPtr dconn,
                                       const char *cookiein, int cookieinlen,
                                       char **cookieout, int *cookieoutlen,
...
static int remoteDomainMigratePrepareTunnel3(
    virConnectPtr dconn, virStreamPtr st, const char *cookiein, int cookieinlen,
    char **cookieout, int *cookieoutlen, unsigned long flags, const char *dname,
    unsigned long bandwidth, const char *dom_xml) {
  struct private_data *priv = dconn->privateData;
  ...
  if (!(netst = virNetClientStreamNew(
            priv->remoteProgram, REMOTE_PROC_DOMAIN_MIGRATE_PREPARE_TUNNEL3,
            priv->counter, false)))
    return -1;
...
static int remoteDomainMigratePerform3(virDomainPtr dom, const char *xmlin,
                                       const char *cookiein, int cookieinlen,
                                       char **cookieout, int *cookieoutlen,
...
static virDomainPtr remoteDomainMigrateFinish3(
    virConnectPtr dconn, const char *dname, const char *cookiein,
    int cookieinlen, char **cookieout, int *cookieoutlen, const char *dconnuri,
    const char *uri, unsigned long flags, int cancelled) {
...
static int remoteDomainMigrateConfirm3(virDomainPtr domain,
                                       const char *cookiein, int cookieinlen,
                                       unsigned long flags, int cancelled) {
...
static int remoteConnectGetCPUModelNames(virConnectPtr conn, const char *arch,
  ...
  if (call(conn, priv, 0, REMOTE_PROC_CONNECT_GET_CPU_MODEL_NAMES,
           ...
           (char *)&args, (xdrproc_t)xdr_remote_connect_get_cpu_model_names_ret,
           (char *)&ret) < 0)
    return -1;
...
static int remoteDomainOpenGraphics(virDomainPtr dom, unsigned int idx, int fd,
                                    unsigned int flags) {
  ...
  if (callFull(dom->conn, priv, 0, fdin, fdinlen, NULL, NULL,
...
static int remoteDomainOpenGraphicsFD(virDomainPtr dom, unsigned int idx,
                                      unsigned int flags) {
  int rv = -1;
  ...
  if (callFull(dom->conn, priv, 0, NULL, 0, &fdout, &fdoutlen,
               REMOTE_PROC_DOMAIN_OPEN_GRAPHICS_FD,
               (xdrproc_t)xdr_remote_domain_open_graphics_fd_args,
               (char *)&args, (xdrproc_t)xdr_void, NULL) == -1)
    return -1;
...
static int remoteConnectSetKeepAlive(virConnectPtr conn, int interval,
                                     unsigned int count) {
  struct private_data *priv = conn->privateData;
  VIR_LOCK_GUARD lock = remoteDriverLock(priv);
  ...
  if (!virNetClientKeepAliveIsSupported(priv->client)) {
    virReportError(VIR_ERR_INTERNAL_ERROR, "%s",
                   _("the caller doesn't support keepalive protocol; perhaps "
                     "it's missing event loop implementation"));
    return -1;
  }
...
static int remoteConnectIsAlive(virConnectPtr conn) {
  struct private_data *priv = conn->privateData;
  bool ret;
  VIR_LOCK_GUARD lock = remoteDriverLock(priv);
...
static int remoteDomainGetDiskErrors(virDomainPtr dom,
  ...
  if (call(dom->conn, priv, 0, REMOTE_PROC_DOMAIN_GET_DISK_ERRORS,
           (xdrproc_t)xdr_remote_domain_get_disk_errors_args, (char *)&args,
           (xdrproc_t)xdr_remote_domain_get_disk_errors_ret,
           (char *)&ret) == -1)
    return -1;

  if (remoteDeserializeDomainDiskErrors(
          ret.errors.errors_val, ret.errors.errors_len,
          REMOTE_DOMAIN_DISK_ERRORS_MAX, errors, maxerrors) < 0)
    return -1;
 ...
 */
static int callFull(virConnectPtr conn G_GNUC_UNUSED, struct private_data *priv,
                    unsigned int flags, int *fdin, size_t fdinlen, int **fdout,
                    size_t *fdoutlen, int proc_nr, xdrproc_t args_filter,
                    char *args, xdrproc_t ret_filter, char *ret) {
  int rv;
   ...
   */
  remoteDriverUnlock(priv);
  rv = virNetClientProgramCall(prog, client, counter, proc_nr, fdinlen, fdin,
                               fdoutlen, fdout, args_filter, args, ret_filter,
                               ret);
  remoteDriverLock(priv);
  priv->localUses--;
...
static int call(virConnectPtr conn, struct private_data *priv,
                unsigned int flags, int proc_nr, xdrproc_t args_filter,
                char *args, xdrproc_t ret_filter, char *ret) {
  return callFull(conn, priv, flags, NULL, 0, NULL, NULL, proc_nr, args_filter,
                  args, ret_filter, ret);
}

static int remoteDomainGetInterfaceParameters(virDomainPtr domain,
                                              const char *device,
                                              virTypedParameterPtr params,
                                              int *nparams,
                                              unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_INTERFACE_PARAMETERS_MAX,
          &params, nparams) < 0)
    return -1;
...
static int remoteNodeGetMemoryParameters(virConnectPtr conn,
                                         virTypedParameterPtr params,
                                         int *nparams, unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_NODE_MEMORY_PARAMETERS_MAX, &params,
          nparams) < 0)
    return -1;
...
static int remoteNodeGetSEVInfo(virConnectPtr conn,
                                virTypedParameterPtr *params, int *nparams,
                                unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_NODE_SEV_INFO_MAX, params, nparams) < 0)
    return -1;

  return 0;
}

static int remoteNodeGetCPUMap(virConnectPtr conn, unsigned char **cpumap,
  ...
  if (call(conn, priv, 0, REMOTE_PROC_NODE_GET_CPU_MAP,
           (xdrproc_t)xdr_remote_node_get_cpu_map_args, (char *)&args,
           (xdrproc_t)xdr_remote_node_get_cpu_map_ret, (char *)&ret) == -1)
    return -1;
...
static int remoteDomainLxcOpenNamespace(virDomainPtr domain, int **fdlist,
                                        unsigned int flags) {
  ...
  *fdlist = NULL;
  ...
  if (callFull(domain->conn, priv, REMOTE_CALL_LXC, NULL, 0, fdlist, &nfds,
...
static int remoteDomainGetJobStats(virDomainPtr domain, int *type,
                                   virTypedParameterPtr *params, int *nparams,
                                   unsigned int flags) {
  ...
  *type = ret.type;
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_JOB_STATS_MAX, params,
          nparams) < 0)
    return -1;
...
static char *remoteDomainMigrateBegin3Params(virDomainPtr domain,
                                             virTypedParameterPtr params,
                                             int nparams, char **cookieout,
                                             int *cookieoutlen,
                                             unsigned int flags) {
  char *rv = NULL;
  ...
  if (virTypedParamsSerialize(
          params, nparams, REMOTE_DOMAIN_MIGRATE_PARAM_LIST_MAX,
          (struct _virTypedParameterRemote **)&args.params.params_val,
          &args.params.params_len, VIR_TYPED_PARAM_STRING_OKAY) < 0)
    return NULL;
...
static int remoteDomainMigratePrepare3Params(virConnectPtr dconn,
                                             virTypedParameterPtr params,
                                             int nparams, const char *cookiein,
                                             int cookieinlen, char **cookieout,
                                             int *cookieoutlen, char **uri_out,
                                             unsigned int flags) {
  int rv = -1;
...
static int remoteDomainMigratePrepareTunnel3Params(
    virConnectPtr dconn, virStreamPtr st, virTypedParameterPtr params,
    int nparams, const char *cookiein, int cookieinlen, char **cookieout,
    int *cookieoutlen, unsigned int flags) {
  struct private_data *priv = dconn->privateData;
  int rv = -1;
  ...
  if (!(netst = virNetClientStreamNew(
            priv->remoteProgram,
            REMOTE_PROC_DOMAIN_MIGRATE_PREPARE_TUNNEL3_PARAMS, priv->counter,
            false)))
    goto cleanup;
...
static int remoteDomainMigratePerform3Params(
    virDomainPtr dom, const char *dconnuri, virTypedParameterPtr params,
    int nparams, const char *cookiein, int cookieinlen, char **cookieout,
    int *cookieoutlen, unsigned int flags) {
  int rv = -1;
...
static virDomainPtr remoteDomainMigrateFinish3Params(
    virConnectPtr dconn, virTypedParameterPtr params, int nparams,
    const char *cookiein, int cookieinlen, char **cookieout, int *cookieoutlen,
    unsigned int flags, int cancelled) {
...
static int remoteDomainMigrateConfirm3Params(
    virDomainPtr domain, virTypedParameterPtr params, int nparams,
    const char *cookiein, int cookieinlen, unsigned int flags, int cancelled) {
  int rv = -1;
...
static virDomainPtr remoteDomainCreateXMLWithFiles(virConnectPtr conn,
                                                   const char *xml_desc,
                                                   unsigned int nfiles,
                                                   int *files,
                                                   unsigned int flags) {
  ...
  if (callFull(conn, priv, 0, files, nfiles, NULL, NULL,
...
static int remoteDomainCreateWithFiles(virDomainPtr dom, unsigned int nfiles,
  ...
  if (callFull(dom->conn, priv, 0, files, nfiles, NULL, NULL,
...
static int remoteDomainGetTime(virDomainPtr dom, long long *seconds,
...
static int remoteNodeGetFreePages(virConnectPtr conn, unsigned int npages,
                                  unsigned int *pages, int startCell,
  ...
  if (npages * cellCount > REMOTE_NODE_MAX_CELLS) {
    virReportError(VIR_ERR_RPC, _("too many NUMA cells: %1$d > %2$d"),
  ...
  memcpy(counts, ret.counts.counts_val,
         ret.counts.counts_len * sizeof(*counts));

  return ret.counts.counts_len;
}

/* Copy contents of remote_network_dhcp_lease to virNetworkDHCPLeasePtr */
static int remoteSerializeDHCPLease(virNetworkDHCPLeasePtr lease_dst,
                                    remote_network_dhcp_lease *lease_src) {
...
static int remoteNetworkGetDHCPLeases(virNetworkPtr net, const char *mac,
...
static int remoteConnectGetAllDomainStats(virConnectPtr conn,
                                          virDomainPtr *doms,
                                          unsigned int ndoms,
                                          unsigned int stats,
  ...
  *retStats = NULL;
  ...
  for (i = 0; i < ret.retStats.retStats_len; i++) {
    ...
    if (virTypedParamsDeserialize(
            (struct _virTypedParameterRemote *)rec->params.params_val,
            rec->params.params_len, REMOTE_CONNECT_GET_ALL_DOMAIN_STATS_MAX,
            &elem->params, &elem->nparams))
      goto cleanup;
...
static int remoteNodeAllocPages(virConnectPtr conn, unsigned int npages,
                                unsigned int *pageSizes,
                                unsigned long long *pageCounts, int startCell,
                                unsigned int cellCount, unsigned int flags) {
  ...
  if (npages > REMOTE_NODE_MAX_CELLS) {
    virReportError(VIR_ERR_RPC, _("too many NUMA cells: %1$d > %2$d"), npages,
                   REMOTE_NODE_MAX_CELLS);
    return -1;
  }
...
static int remoteDomainGetFSInfo(virDomainPtr dom, virDomainFSInfoPtr **info,
                                 unsigned int flags) {
  size_t i, j, len;
  struct private_data *priv = dom->conn->privateData;
  ...
  if (info) {
    ...
    for (i = 0; i < ret.info.info_len; i++) {
      ...
      for (j = 0; j < len; j++)
        info_ret[i]->devAlias[j] =
            g_strdup(src->dev_aliases.dev_aliases_val[j]);
    }
...
static int remoteDomainInterfaceAddresses(virDomainPtr dom,
  ...
  if (call(dom->conn, priv, 0, REMOTE_PROC_DOMAIN_INTERFACE_ADDRESSES,
           (xdrproc_t)xdr_remote_domain_interface_addresses_args, (char *)&args,
  ...
  for (i = 0; i < ret.ifaces.ifaces_len; i++) {
    ...
    if (iface->naddrs) {
      ...
      for (j = 0; j < iface->naddrs; j++) {
        ...
        remote_domain_ip_addr *ip_addr_ret = &(iface_ret->addrs.addrs_val[j]);
...
static int remoteConnectRegisterCloseCallback(virConnectPtr conn,
  ...
  virConnectCloseCallbackDataRegister(priv->closeCallback, conn, cb, opaque,
                                      freecb);
  return 0;
}

static int remoteConnectUnregisterCloseCallback(virConnectPtr conn,
                                                virConnectCloseFunc cb) {
  struct private_data *priv = conn->privateData;
  VIR_LOCK_GUARD lock = remoteDriverLock(priv);
...
static int remoteDomainRename(virDomainPtr dom, const char *new_name,
                              unsigned int flags) {
  int rv = -1;
  struct private_data *priv = dom->conn->privateData;
...
static int remoteStorageVolGetInfoFlags(virStorageVolPtr vol,
  ...
  if (call(vol->conn, priv, 0, REMOTE_PROC_STORAGE_VOL_GET_INFO_FLAGS,
           (xdrproc_t)xdr_remote_storage_vol_get_info_flags_args, (char *)&args,
...
static int remoteNetworkPortGetParameters(virNetworkPortPtr port,
                                          virTypedParameterPtr *params,
                                          int *nparams, unsigned int flags) {
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_NETWORK_PORT_PARAMETERS_MAX, params,
          nparams) < 0)
    return -1;
...
static int remoteDomainGetGuestInfo(virDomainPtr dom, unsigned int types,
                                    virTypedParameterPtr *params, int *nparams,
                                    unsigned int flags) {
  struct private_data *priv = dom->conn->privateData;
  ...
  if (virTypedParamsDeserialize(
          (struct _virTypedParameterRemote *)ret.params.params_val,
          ret.params.params_len, REMOTE_DOMAIN_GUEST_INFO_PARAMS_MAX, params,
          nparams) < 0)
    return -1;
...
static int remoteDomainAuthorizedSSHKeysGet(virDomainPtr domain,
                                            const char *user, char ***keys,
                                            unsigned int flags) {
  size_t i;
  struct private_data *priv = domain->conn->privateData;
...
static int remoteDomainAuthorizedSSHKeysSet(virDomainPtr domain,
                                            const char *user, const char **keys,
                                            unsigned int nkeys,
                                            unsigned int flags) {
  struct private_data *priv = domain->conn->privateData;
  ...
  if (nkeys > REMOTE_DOMAIN_AUTHORIZED_SSH_KEYS_MAX) {
    virReportError(VIR_ERR_RPC, "%s",
                   _("remoteDomainAuthorizedSSHKeysSet: returned number of "
                     "keys exceeds limit"));
    return -1;
  }
...
static int remoteDomainGetMessages(virDomainPtr domain, char ***msgs,
                                   unsigned int flags) {
  size_t i;
  struct private_data *priv = domain->conn->privateData;
...
static int remoteDomainFDAssociate(virDomainPtr domain, const char *name,
                                   unsigned int nfds, int *fds,
                                   unsigned int flags) {
...
static virStoragePoolPtr
get_nonnull_storage_pool(virConnectPtr conn, remote_nonnull_storage_pool pool) {
  return virGetStoragePool(conn, pool.name, BAD_CAST pool.uuid, NULL, NULL);
}
...
static virSecretPtr get_nonnull_secret(virConnectPtr conn,
                                       remote_nonnull_secret secret) {
  return virGetSecret(conn, BAD_CAST secret.uuid, secret.usageType,
                      secret.usageID);
}
...
static virHypervisorDriver hypervisor_driver = {
    ...
    .domainGetSchedulerParameters =
        remoteDomainGetSchedulerParameters, /* 0.3.0 */
    .domainGetSchedulerParametersFlags =
        remoteDomainGetSchedulerParametersFlags, /* 0.9.2 */
    .domainSetSchedulerParameters =
        remoteDomainSetSchedulerParameters, /* 0.3.0 */
    ...
    .domainSetInterfaceParameters =
        remoteDomainSetInterfaceParameters, /* 0.9.9 */
    .domainGetInterfaceParameters =
        remoteDomainGetInterfaceParameters,                         /* 0.9.9 */
    ...
    .connectDomainEventDeregister =
        remoteConnectDomainEventDeregister,                         /* 0.5.0 */
    ...
    .domainMigrateGetMaxDowntime =
        remoteDomainMigrateGetMaxDowntime, /* 3.7.0 */
    ...
    .connectDomainEventRegisterAny =
        remoteConnectDomainEventRegisterAny, /* 0.8.0 */
    .connectDomainEventDeregisterAny =
        remoteConnectDomainEventDeregisterAny,                    /* 0.8.0 */
    ...
    .domainManagedSaveGetXMLDesc =
        remoteDomainManagedSaveGetXMLDesc,                          /* 3.7.0 */
    ...
    .domainSnapshotListAllChildren =
        remoteDomainSnapshotListAllChildren, /* 0.9.13 */
    ...
    .domainQemuMonitorCommandWithFiles =
        remoteDomainQemuMonitorCommandWithFiles,            /* 8.2.0 */
    ...
    .connectDomainQemuMonitorEventRegister =
        remoteConnectDomainQemuMonitorEventRegister, /* 1.2.3 */
    ...
    .domainMigratePrepareTunnel3 =
        remoteDomainMigratePrepareTunnel3,                        /* 0.9.2 */
    ...
    .domainMigratePrepare3Params =
        remoteDomainMigratePrepare3Params, /* 1.1.0 */
    .domainMigratePrepareTunnel3Params =
        remoteDomainMigratePrepareTunnel3Params, /* 1.1.0 */
    .domainMigratePerform3Params =
        remoteDomainMigratePerform3Params,                          /* 1.1.0 */
    .domainMigrateFinish3Params = remoteDomainMigrateFinish3Params, /* 1.1.0 */
    .domainMigrateConfirm3Params =
        remoteDomainMigrateConfirm3Params,                    /* 1.1.0 */
    ...
    .connectRegisterCloseCallback =
        remoteConnectRegisterCloseCallback, /* 1.3.2 */
    .connectUnregisterCloseCallback =
        remoteConnectUnregisterCloseCallback,                       /* 1.3.2 */
    ...
    .connectCompareHypervisorCPU =
        remoteConnectCompareHypervisorCPU, /* 4.4.0 */
    .connectBaselineHypervisorCPU =
        remoteConnectBaselineHypervisorCPU, /* 4.4.0 */
    .nodeGetSEVInfo = remoteNodeGetSEVInfo, /* 4.5.0 */
    .domainGetLaunchSecurityInfo =
        remoteDomainGetLaunchSecurityInfo,                          /* 4.5.0 */
    ...
    .domainCheckpointListAllChildren =
        remoteDomainCheckpointListAllChildren, /* 5.6.0 */
    .domainCheckpointLookupByName =
        remoteDomainCheckpointLookupByName,                       /* 5.6.0 */
    ...
    .domainAgentSetResponseTimeout =
        remoteDomainAgentSetResponseTimeout,                        /* 5.10.0 */
    ...
    .domainSetLaunchSecurityState =
        remoteDomainSetLaunchSecurityState,                 /* 8.0.0 */
...
static virNetworkDriver network_driver = {
    ...
    .connectNumOfDefinedNetworks =
        remoteConnectNumOfDefinedNetworks,                          /* 0.3.0 */
    ...
    .connectNetworkEventDeregisterAny =
        remoteConnectNetworkEventDeregisterAny, /* 1.2.1 */
    .connectNetworkEventRegisterAny =
        remoteConnectNetworkEventRegisterAny,                   /* 1.2.1 */
...
static virInterfaceDriver interface_driver = {
    ...
    .connectNumOfDefinedInterfaces =
        remoteConnectNumOfDefinedInterfaces, /* 0.7.2 */
    .connectListDefinedInterfaces =
        remoteConnectListDefinedInterfaces,                         /* 0.7.2 */
...
static virStorageDriver storage_driver = {
    ...
    .connectNumOfDefinedStoragePools =
        remoteConnectNumOfDefinedStoragePools, /* 0.4.1 */
    .connectListDefinedStoragePools =
        remoteConnectListDefinedStoragePools,                       /* 0.4.1 */
    .connectListAllStoragePools = remoteConnectListAllStoragePools, /* 0.10.2 */
    .connectFindStoragePoolSources =
        remoteConnectFindStoragePoolSources, /* 0.4.5 */
    .connectStoragePoolEventDeregisterAny =
        remoteConnectStoragePoolEventDeregisterAny, /* 2.0.0 */
    .connectStoragePoolEventRegisterAny =
        remoteConnectStoragePoolEventRegisterAny, /* 2.0.0 */
    .connectGetStoragePoolCapabilities =
        remoteConnectGetStoragePoolCapabilities,                  /* 5.2.0 */
    ...
    .storagePoolLookupByTargetPath =
        remoteStoragePoolLookupByTargetPath,                      /* 4.1.0 */
...
static virSecretDriver secret_driver = {
    ...
    .connectSecretEventDeregisterAny =
        remoteConnectSecretEventDeregisterAny, /* 3.0.0 */
    .connectSecretEventRegisterAny =
        remoteConnectSecretEventRegisterAny, /* 3.0.0 */
};

static virNodeDeviceDriver node_device_driver = {
    .connectNodeDeviceEventDeregisterAny =
        remoteConnectNodeDeviceEventDeregisterAny, /* 2.2.0 */
    .connectNodeDeviceEventRegisterAny =
        remoteConnectNodeDeviceEventRegisterAny,                  /* 2.2.0 */
    ...
    .nodeDeviceLookupSCSIHostByWWN =
        remoteNodeDeviceLookupSCSIHostByWWN,                /* 1.0.2 */
...
static virNWFilterDriver nwfilter_driver = {
    ...
    .connectListAllNWFilterBindings =
        remoteConnectListAllNWFilterBindings, /* 4.5.0 */
    .nwfilterBindingLookupByPortDev =
        remoteNWFilterBindingLookupByPortDev,                     /* 4.5.0 */
...
int remoteRegister(void) {
  if (virRegisterConnectDriver(&connect_driver, false) < 0)
    return -1;
